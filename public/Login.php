...
<body class="po">
    ...
    <div class="conta">
        ...
        <div id="test-swipe-3" class="col s12">
            ...
            <a class="waves-effect waves-light btn" href="#modal1">Registrarse</a>

            <!-- Modal Structure -->
            <div id="modal1" class="modal">
                <div class="modal-content">
                <h4>Terminos y condiciones</h4>
                <p>La cuenta le proporciona diferentes servicios a usted como usuario tiene diferentes beneficios
                 en los cuales puede tene puntos por cada compra y poder tener cupones de descuento, entre demas cosas.</p>
                </div>
