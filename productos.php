<!DOCTYPE html>
  <html lang="ES">
    ...
    <nav>
        ...
        <a href="#!" class="brand-logo"><img class="pequeña" src="img/Original.png"></a>
        <ul class="right hide-on-med-and-down">
            <li><a href="index.php" class="black-text ">Inicio<i class="material-icons left">home</i></a></li>
            <li><a href="index.php" class="black-text ">Login<i class="material-icons left">person</i></a></li>
            <li><a href="productos.php" class="black-text ">Productos<i class="material-icons left">watch</i></i></a></li>
            <li><a href="soporte.php" class="black-text ">Cuenta<i class="material-icons left">portrait</i></a></li>
            <li><a href="nosotros.php" class="black-text ">Nosotros<i class="material-icons left">business</i></a></li>
            <li><a href="carrito.php" class="black-text "><i class="material-icons">local_grocery_store</i></a></li>
            <li><a href="soporte.php" class="black-text "><i class="material-icons">build</i></a></li>
        </ul>
        </div>
    </nav>
    </div>
    ...
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator grande" src="img/sony2.jpeg">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Sony SW 3<i class="material-icons right">more_vert</i></span>
  ...
  <div class="col s4 m4">
        <div class="card">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator grande" src="img/moto2.jpg">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Moto 360<i class="material-icons right">more_vert</i></span>
      <p><a href="#">Comprar<i class="material-icons left">shopping_cart</i></a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4"><Especificaciones></Especificaciones><i class="material-icons right">close</i></span>
  ...
  <div class="col s4 m4">
        <div class="card">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator grande" src="img/samsung2.png">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Samsung Gear S2<i class="material-icons right">more_vert</i></span>
      <p><a href="#">Comprar<i class="material-icons left">shopping_cart</i></a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4"><Especificaciones></Especificaciones><i class="material-icons right">close</i></span>
...
<div class="container">
        ...
        <div class="card">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator correcto" src="img/rolex.jpg">
    </div>
    <div class="card-content">
...
de alto rendimiento por su nombre y función.</p>
  ...
  <div class="col s4 m4">
        <div class="card">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator correcto" src="img/rolex2.jpg">
    </div>
    <div class="card-content">
  ...
  <div class="col s4 m4">
        <div class="card">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator correcto" src="img/rolex3.jpg">
    </div>
    <div class="card-content">
